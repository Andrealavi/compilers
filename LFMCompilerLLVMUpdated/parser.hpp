...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // condexpr
      char dummy4[sizeof (IfExprAST*)];

      // letexpr
      char dummy5[sizeof (LetExprAST*)];
      ...
      // pair
      char dummy8[sizeof (std::pair<ExprAST*, ExprAST*>)];

      // binding
      char dummy9[sizeof (std::pair<std::string, ExprAST*>)];

      // "id"
      char dummy10[sizeof (std::string)];

      // deflist
      char dummy11[sizeof (std::vector<DefAST*>)];
      ...
      // pairs
      char dummy13[sizeof (std::vector<std::pair<ExprAST*, ExprAST*>>)];

      // bindings
      char dummy14[sizeof (std::vector<std::pair<std::string, ExprAST*>>)];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_deflist = 38,                          // deflist
        S_def = 39,                              // def
        S_extdef = 40,                           // extdef
        S_funcdef = 41,                          // funcdef
        S_prototype = 42,                        // prototype
        S_params = 43,                           // params
        S_expr = 44,                             // expr
        S_arglist = 45,                          // arglist
        S_args = 46,                             // args
        S_condexpr = 47,                         // condexpr
        S_pairs = 48,                            // pairs
        S_pair = 49,                             // pair
        S_boolexpr = 50,                         // boolexpr
        S_literal = 51,                          // literal
        S_relexpr = 52,                          // relexpr
        S_letexpr = 53,                          // letexpr
        S_bindings = 54,                         // bindings
        S_binding = 55                           // binding
      };
    };
